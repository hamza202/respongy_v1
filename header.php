            ...
            <div class="row">
                ...
                <div class="cell-10 top-menu">
                    ...
                    <nav class="top-nav mega-menu">
                        <ul>
                            <li class="selected"><a href="index.php"><i class="fa fa-home"></i><span>Home</span></a>
                            </li>
                            <li><a href="#"><i class="fa fa-building"></i><span>Company</span></a>
                                <ul>
                                    <li><a href="#"><i class="fa fa-send"></i>1</a>
                                    </li>
                                    <li><a href="#"><i class="fa fa-send"></i>2</a>
                                    </li>
                                    <li><a href="#"><i class="fa fa-send"></i>3</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="#"><i class="fa fa-leaf"></i><span>Solution</span></a>
                            </li>
                            <li><a href="#"><i class="fa fa-university"></i><span>Consulting</span></a>
                            </li>
